function getInputValue_l(){
    ...
    var login_button = document.getElementById("login_button_left");
...
function getInputValue_r(){
    var inputpassword = document.getElementById("password_s").value;
    var login_button = document.getElementById("login_button_right");
